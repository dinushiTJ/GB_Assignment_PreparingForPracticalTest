package com.paymentclientapp.model;
...
public class Payment extends DBHandler{
	...
	//Insert Payment
	public JsonObject insertPayment(String consumer_id, String product_id, float payment_amount, String creditcard_no, String creditcard_type) {
		JsonObject result = null;
		try {
			...
			callableStmt.setString(5, creditcard_type);
	...
	//Update Payment
	public JsonObject updatePayment(String payment_id, String consumer_id, String product_id, float payment_amount, String creditcard_no, String creditcard_type)
	{
		JsonObject result = null;
		try {
			//Verify Payment using service-to-service communication
			...
			callableStmt.setString(6, creditcard_type);
